    ...
    <header className="sticky top-0 z-40 border-b border-white/8 bg-[#0b0e0d]/90 backdrop-blur-xl">
      <div className="mx-auto flex h-18 max-w-7xl items-center gap-8 px-5 sm:px-8">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Link href="/login" aria-label="Iniciar sesión" className="flex h-10 items-center gap-2 rounded-full border border-white/12 px-3 text-sm text-[#e8e3d8] transition hover:border-[#bf9f63]/60 sm:px-4"><UserIcon className="size-4" /><span className="hidden sm:inline">Ingresar</span></Link>
        </div>
      </div>
    </header>
  );
